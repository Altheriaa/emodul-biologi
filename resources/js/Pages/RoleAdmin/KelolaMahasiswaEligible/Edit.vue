...
function update() {
    form.put(`/admin/mahasiswa-eligible/${props.mahasiswa.id}`);
}
</script>
    ...
    <Layout>
        ...
        <div class="grid grid-cols-1 gap-4 mb-6">
            <div class="bg-white border border-gray-200 rounded-xl p-4 sm:p-6 shadow-sm">
                <p class="text-xl sm:text-2xl font-bold text-gray-800 tracking-tight">Edit Data Master Mahasiswa</p>
                <p class="text-xs sm:text-sm text-green-600 mt-1">Halaman untuk memperbarui data mahasiswa yang eligible untuk mendaftar</p>
            </div>
        </div>
