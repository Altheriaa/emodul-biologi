...
const form = useForm({
    ...
    description: props.quizzes.description,
    duration_minutes: props.quizzes.duration_minutes,
    status: props.quizzes.status,
});
...
const submit = () => {
    form.put(`/admin/evaluasi/bank-soal/${props.quizzes.id}`, {
        preserveScroll: true,
    });
};
