...
<template>
    <Layout>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <!-- grid 1 -->
            <div class="col-span-1 row-span-2 bg-white border border-gray-200 rounded-xl p-4 sm:p-5">
                <img src="/asset/dashboard_overview.png" alt="" class="shadow-lg w-full h-auto rounded-xl mb-5">

                <h2 class="text-xl sm:text-2xl font-bold text-gray-800 tracking-tight mb-3">Anatomi Tumbuhan</h2>
